...
public class HospitalDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer(
            "Server=localhost,1433;Database=HospitalManagementSystemDB;User Id=sa;Password=Yosuef@2026;TrustServerCertificate=True;"
        );
    }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
{
    ...
    modelBuilder.Entity<Patient>().HasData(
        new { Id = 1, Name = "Ahmed Ali", Phone = "01012345678" },
        new { Id = 2, Name = "Sara Hassan", Phone = "01023456789" },
        new { Id = 3, Name = "Mohamed Tamer", Phone = "01034567890" },
        new { Id = 4, Name = "Laila Fathy", Phone = "01045678901" },
        new { Id = 5, Name = "Omar Mostafa", Phone = "01056789012" },
        new { Id = 6, Name = "Nour El-Din", Phone = "01067890123" },
        new { Id = 7, Name = "Hana Mahmoud", Phone = "01078901234" },
        new { Id = 8, Name = "Youssef Samir", Phone = "01089012345" },
        new { Id = 9, Name = "Mona Kamal", Phone = "01090123456" },
        new { Id = 10, Name = "Khaled Adel", Phone = "01001234567" }
    );
